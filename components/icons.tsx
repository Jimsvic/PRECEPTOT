...
// Generic Icon Props
// Fix: Export IconProps to be used in other components for better type safety with icons.
...
export const MegaphoneIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 15h8.05a1.5 1.5 0 00.938-2.653l-3.232-2.39a1.5 1.5 0 010-2.31l3.232-2.39A1.5 1.5 0 0018.55 6H10.5z" />
...
export const OrcidIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M128 0C57.3 0 0 57.3 0 128s57.3 128 128 128 128-57.3 128-128S198.7 0 128 0zM96.2 203.4H72.5V98.6h23.7v104.8zm-11.8-116.2c-7.3 0-13.3-6-13.3-13.3s6-13.3 13.3-13.3 13.3 6 13.3 13.3-6 13.3-13.3 13.3zm70.2 116.2h-23.7V137.9c0-13.3-5.3-20.1-15.9-20.1-8.7 0-13.3 6-15.9 12.6-1.3 2.6-1.3 5.3-1.3 8.7v64.3h-23.7s0-94.8 0-104.8h23.7v10.6c3.3-5.3 8.7-12.6 21.1-12.6 14.6 0 26.4 9.3 26.4 29.5v77.3h-.1z" fill="#a6ce39"/>
    </svg>
);
...
export const ArticleIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3h7.5m-7.5-3h7.5m-1.5-12l-1.5-1.5m0 0l-1.5 1.5m1.5-1.5V5.625M5.625 21V4.5a2.25 2.25 0 012.25-2.25h6a2.25 2.25 0 012.25 2.25v16.5A2.25 2.25 0 0113.875 21H7.875a2.25 2.25 0 01-2.25-2.25z" />
  </svg>
);
...
// Publication visibility and attachment icons
export const GlobeEuropeAfricaIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a8.966 8.966 0 01-5.982-2.275M12 21a8.966 8.966 0 005.982-2.275M12 3a8.966 8.966 0 015.982 2.275M12 3a8.966 8.966 0 00-5.982 2.275" />
...
export const UserGroupIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.023 1.5-1.85 2.6-2.502m5.1 7.712a11.025 11.025 0 01-2.6 2.502m-5.1-7.712A11.025 11.025 0 015.25 6.25m7.5 10.5a11.025 11.025 0 01-7.5 0m7.5 0a11.025 11.025 0 012.6-2.502m-5.1 7.712a5.25 5.25 0 01-5.25-5.25m0 0a5.25 5.25 0 015.25-5.25m0 0a5.25 5.25 0 015.25 5.25m-10.5 0a5.25 5.25 0 015.25-5.25m0 0a5.25 5.25 0 015.25 5.25" />
  </svg>
);

export const PaperClipIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3.375 3.375 0 1118.375 9.02l-7.693 7.693a2.25 2.25 0 01-3.182-3.182l5.364-5.364" />
  </svg>
);
